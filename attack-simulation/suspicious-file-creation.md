...
"test payload" | Out-File "$env:TEMP\\stage\_payload.exe"

"test payload" | Out-File "$env:APPDATA\\chrome\_update.exe"

"test payload" | Out-File "C:\\Users\\Public\\adobe\_patch.bat"
...
!\[File Creation Attack Simulation](../screenshots/24\_FileCreate\_Attack\_Simulation\_PowerShell.png)
...
!\[Sysmon EventID 11 File Creation](../screenshots/25\_Sysmon\_EventID11\_FileCreate\_Event\_Details.png)
...
!\[Splunk Raw File Creation Event](../screenshots/26\_Splunk\_Raw\_FileCreate\_Event\_Search.png)
...
!\[Splunk Detection Result](../screenshots/27\_Splunk\_FileCreate\_Detection\_Result.png)
